...
class CrossDomainMixed(HTMLTemplateView):
    ...
    url_path = 'cross_domain_js/cross_domain_script_mixed.html'
...
class CrossDomainLocal(HTMLTemplateView):
    ...
    url_path = 'cross_domain_js/local_script.html'
...
class CrossDomainExternal(HTMLTemplateView):
    ...
    url_path = 'cross_domain_js/cross_domain_script.html'
...
class CrossDomainWithType(HTMLTemplateView):
    ...
    url_path = 'cross_domain_js/cross_domain_script_with_type.html'
